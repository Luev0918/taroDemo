...
import { getCategoryList, getTagsList,contributeResource } from '@/service/contribute';
...
//
  ...
  const handleUrlChange = e => {
    console.log("contributeForm.downloadUrl",contributeForm.downloadUrl)
    ...
    console.log("打印网盘类型1",contributeForm)
    console.log("打印网盘类型2",contributeTypeList)
